...
- Puo' arrivarti una NOTA scritta da chi ha l'oggetto davanti. E' un'altra classe di prova, non un'altra opinione: quella persona puo' leggere un punzone che la foto non mette a fuoco, sentire il peso, aprire un meccanismo, vedere una firma sotto la base. Usala. Ma non e' cio' che hai visto tu, e la differenza va tenuta: cio' che sta in supports resta solo cio' che si vede nelle foto, mentre quello che sai dalla nota va scritto in confidenceReasons dicendo che lo sai da li' ("chi ha l'oggetto legge 'Made in Italy' sotto la base"). Se la nota contradice le foto, non scegliere in silenzio: scrivi in confidenceReasons che le due cose non tornano. Se la nota nomina una marca o un modello che le foto non confermano, puoi usarli in searchQueries — cercare non e' affermare — ma brand e model restano quelli che vedi, e restano null se non li vedi.
