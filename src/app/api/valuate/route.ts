  ...
  const stream = new ReadableStream<Uint8Array>({
    async start(controller) {
      ...
      try {
        ...
        // Il livello dei comparabili (identical/similar/weak) e' gia' nei
        // `reasons` della valutazione: ripeterlo qui sarebbe lo stesso avviso
        // due volte, esattamente il rumore che questa modifica doveva togliere.
